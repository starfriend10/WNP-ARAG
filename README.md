...
**WNP-ARAG** is an interactive research platform for exploring **wastewater nutrient regulations and policies** through natural-language questions. It integrates regulatory knowledge, semantic retrieval, evidence assessment, and large language models (LLMs) within an agentic Retrieval-Augmented Generation (RAG) framework.
...
- Agentic retrieval with iterative evidence assessment and search refinement
- Evidence-grounded responses with supporting sources
...
```text
Question → Retrieve → Assess Evidence → Refine/Retrieve if needed → Generate
```

This enables the system to search beyond a single retrieval step when regulatory evidence is distributed across multiple documents or contexts.
...
WNP-ARAG is developed as a research platform for investigating how domain-specific retrieval, large language models, and agentic workflows can support environmental regulatory intelligence.
